...
export function SpotifyWidget({ className = '' }: SpotifyWidgetProps) {
  ...
  return (
    <div className={`relative ${className}`}>
      <div className="relative bg-gradient-to-br from-zinc-100 via-zinc-50 to-zinc-100 dark:from-black/20 dark:via-black/80 dark:to-black/20 backdrop-blur-sm border border-zinc-200 dark:border-black/30 rounded-xl p-6 shadow-lg dark:shadow-2xl dark:shadow-black/10">
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-semibold text-zinc-900 dark:text-white drop-shadow-lg">
                  SPOTIFY
                </h3>
               <div className="flex flex-col space-y-1">
  <p className="text-sm text-zinc-600 dark:text-gray-400 font-mono tracking-wider">
    {activeTab === 'recent' ? 'RECENT VIBES' : 'TOP BANGERS'}
  </p>
  <p className="text-xs text-zinc-500 dark:text-gray-400 font-mono tracking-widest">
    Fueled by coffee, code, and Taylor Swift on repeat.
          ...
          {/* Tab Switcher */}
          <div className="flex rounded-lg bg-zinc-200/80 dark:bg-gray-800/50 p-1 border border-zinc-300 dark:border-black/30">
            <button
              onClick={() => setActiveTab('recent')}
              className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-300 ${
                activeTab === 'recent'
                  ? 'bg-white dark:bg-black text-zinc-900 dark:text-white shadow-md dark:shadow-lg dark:shadow-black/50'
                  : 'text-zinc-600 dark:text-gray-300 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-gray-700/50'
              }`}
            >
              Recent
            </button>
        ...
        <div className="space-y-3">
          ...
          {error && (
            <div className="text-center py-8">
              <div className="mb-4">
                <svg className="w-12 h-12 text-zinc-400 dark:text-gray-600 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.47-.881-6.08-2.33" />
                </svg>
                <p className="text-zinc-600 dark:text-gray-400 text-sm mb-2">
              ...
              <button
                ...
                className="text-zinc-600 dark:text-gray-300 hover:text-zinc-900 dark:hover:text-gray-100 text-sm font-medium transition-colors"
              >
                Try again
              </button>
            </div>
                  ...
                  return (
                    ...
                    >
                      <Magnetic springOptions={{ bounce: 0 }} intensity={0.1}>
                        <div className="group flex items-center gap-3 p-3 rounded-lg bg-white/80 dark:bg-gray-900/20 border border-zinc-200 dark:border-gray-400/20 hover:bg-zinc-50 dark:hover:bg-gray-800/50 transition-all duration-300 hover:border-zinc-300 dark:hover:border-black/50 shadow-sm dark:shadow-md hover:shadow-md dark:hover:shadow-black/20">
                          <div className="relative">
                            <img
                              ...
                              width={48}
                              height={48}
                              className="rounded-md border border-zinc-200 dark:border-black/30"
                              loading="lazy"
                            />
                            {track.preview_url && (
                              <>
                          ...
                          <div className="flex-1 min-w-0">
                            <a
                              ...
                              className="block hover:text-emerald-600 dark:hover:text-gray-100 transition-colors"
                            >
                              <p className="font-medium text-zinc-900 dark:text-gray-100 truncate">
                                {track.name}
                              </p>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-zinc-400 dark:text-gray-500 hover:text-emerald-600 dark:hover:text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity"
