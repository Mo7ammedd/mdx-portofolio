...
// Lazy load heavy components - not critical for initial render
...
const Magnetic = dynamic(() => import('@/components/ui/magnetic').then(mod => ({ default: mod.Magnetic })), {
  ssr: false,
...
export default function Personal() {
  ...
  const connectSection = useInView()
  ...
  return (
    ...
    >
      ...
      >
        ...
        {blogSection.isInView && AnimatedBackground && (
      ...
      <motion.section
        ref={spotifySection.ref}
        variants={VARIANTS_SECTION}
        transition={TRANSITION_SECTION}
      >
        {spotifySection.isInView && <SpotifyWidget />}
      </motion.section>

      <motion.section
        ref={connectSection.ref}
        variants={VARIANTS_SECTION}
        transition={TRANSITION_SECTION}
      >
