...
export const metadata = generateBlogPostSEO({
  ...
  description: 'Inline delegates, convention-based middleware, and IMiddleware, with examples and dependency lifetime notes.',
...
In ASP.NET Core, <Term id="middleware">middleware</Term> processes HTTP requests and responses through a pipeline.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>High</td>
      <td>Excellent</td>
      <td>Many dependencies or strict test-isolation needs</td>
    </tr>
  </tbody>
</table>
