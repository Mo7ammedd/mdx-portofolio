...
export const metadata = generateBlogPostSEO({
  ...
  description: 'What boxing and unboxing do in C#, where allocations happen, and how typed collections avoid boxing.',
  slug: 'boxing-and-unboxing-in-csharp',
  publishedTime: '2023-08-22T10:00:00.000Z',
...
<Term id="boxing">Boxing</Term> and unboxing describe how the .NET runtime moves data between **value types** and **reference types**.
...
![Stack vs Heap in .NET](/blog/BoxingUnboxing/stack-vs-heap-dotnet.webp)
...
```csharp title="ArrayListExample.cs" {4} showLineNumbers
...
```csharp title="GenericListExample.cs" {1,4} showLineNumbers
